...
const Navbar = () => {
  ...
  const handleLogOut = () => {
   ...
   <>
    ...
    <li> <NavLink className='text-black' to="/"><a>Home</a></NavLink> </li>
    <li> <NavLink className='text-black' to="/addProduct"><a>Add Product</a></NavLink> </li>
    <li> <NavLink className='text-black' to="/myCart"><a> My Cart</a></NavLink> </li>
  ...
  <div className="navbar-start">
   ...
   <div>
   <a className=" normal-case text-4xl font-bold text-[#001524]">Fashion Show</a>
   </div>
    </div>
    </Link>
  </div>
